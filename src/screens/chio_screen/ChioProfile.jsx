  ...
  return (
    ...
    >
      ...
      <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
        <li style={{ margin: "8px 0", color: "#fff" }}>
          Games Tracked: {gamesTracked}
        </li>
        <li style={{ margin: "8px 0", color: "#fff" }}>
        ...
        {items.length === 0 ? (
          ...
          items.map((item, i) => (
            ...
            >
              ...
              <h4 style={{ margin: "4px 0", fontSize: "16px" }}>
                {item.title}
              </h4>
...
function ChioProfile() {
  ...
  const recentActivity = [
    ...
    {
      title: "Daily Quest",
      detail: "Completed Genshin commissions",
      icon: "📜",
    },
  ];
  ...
  const styles = {
    dashboard: {
      ...
      minHeight: "100vh",
      background:
        "radial-gradient(circle at top left, rgba(0, 255, 255, 0.15), transparent 40%), radial-gradient(circle at bottom right, rgba(255, 0, 255, 0.15), transparent 40%), linear-gradient(135deg, #00000097, #07034885, #2a1b0f)",
              ...
              <div style={styles.profileStats}>
                <div style={styles.statItem}>
                  <span style={styles.statValue}>
                    {profile.hoursAllTime.toLocaleString()}
                  </span>
